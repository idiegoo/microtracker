...
const ParaderoForm = () => {
  ...
  return(
    <div className='d-flex justify-content-center align-items-center'>
      <div className='container-md p-1 pt-5 pb-5 m-4 rounded text-center d-flex align-items-center justify-content-center flex-column bg-white bg-opacity-50 shadow'>
        ...
        <form className='w-50' onSubmit={handleSubmit}>
          ...
          />
          <h2 className='text-nowrap d-flex align-self-center'>Servicio (OPCIONAL)</h2>
          <input
            minLength={3}
            maxLength={6}
            className='form-control form-control-lg'
          ...
          <button
            className='btn btn-primary btn-lg shadow' type="submit"
          >Enviar</button>
        </form>
